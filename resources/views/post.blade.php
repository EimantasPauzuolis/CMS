...
<!-- Page Content -->
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7 col-lg-offset-2 card">
                    <!-- Blog Post -->
                    <!-- Title -->
                <div class="post-body">
                        ...
                        <!-- Author -->
                        <h4 class="lead">
                            by <a href="/profile/{{$post->user->id}}">{{$post->user->name}}</a>
                        </h4>
                        <hr>
                        <!-- Date/Time -->
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-lg-offset-3">
                                <img class="img-responsive" src="{{$post->photo->path}}" alt="No image" height="150">
                            </div>
                        </div>
                        <hr>
                        @endif
            ...
            <!-- Blog Sidebar -->
            <div class="col-lg-2 col-lg-offset-1 card-no-padding" id="post-sidebar">
                {{--<!-- Blog Search Well -->--}}
